...
const handleChange = (event, newValue) => {//Lorsque la valeur du slidr change la fonction handleChange sera appellé" et qui mettra à jour l'état local avec la nouvelle
