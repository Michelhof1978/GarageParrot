...
const handleChange = (event, newValue) => {//Lorsque la valeur du slidr change la fonction handleChange sera appellé" et qui mettra à jour l'état local avec la nouvelle valeur
 
  setValue(newValue);
 props.handleChange(name,newValue); //la fonction sera appelé par handleChange si une valeur change et Va transmettre cette valeur au compmosant parentavec 
