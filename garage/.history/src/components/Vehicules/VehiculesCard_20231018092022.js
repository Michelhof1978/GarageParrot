    ...
    <div>
      <Row>
        {currentCards.map((vehicule) => (
          <Col key={vehicule.idVehicule} lg={4} md={6} sm={12} xs={12}>
            <Card className="mt-4 ms-2 me-2">
              <Card.Img
                variant="top"
              ...
              <Card.Body>
                ...
                <Card.Text>Modèle: {vehicule.modele}</Card.Text>
                <Card.Text>Énergie: {vehicule.energie}</Card.Text>
                <Card.Text>Prix: {vehicule.prix} €</Card.Text>
              </Card.Body>
              <Card.Footer>
                <Link to={`/vehiculedetail/${vehicule.idVehicule}`} className="btn btn-primary">
                  En savoir plus
                </Link>
              </Card.Footer>
            </Card>
