...
const VehiculeFilters = ({ onSearch }) => {
  ...
  const handleChange = (name, newValue) => {
    //Intermediaire entre parent et fils pour pouvoir modifier le state car entre fils et parent, c'est pas possible, il sera passer en props pour chaque composant fils
