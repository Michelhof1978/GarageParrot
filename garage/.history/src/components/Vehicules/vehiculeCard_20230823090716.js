...
const VehiculeCard = () => {
  ...
  const vehiculesAffiches = vehicules.slice(indexDePremierVehicule, indexDeDernierVehicule);//slice va prendre les indices de début et de fin du tableau et va extraire
