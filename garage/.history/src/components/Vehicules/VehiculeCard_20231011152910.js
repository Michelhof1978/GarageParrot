...
const VehiculeCard = () => {
  ...
  const cardsPerPageDesktop = 10; // Nombre de cartes par page en mode desktop
  const cardsPerPageMobile = 6; // Nombre de cartes par page en mode mobile
  const cardsPerRowDesktop = 5; // Nombre de cartes par ligne en mode desktop
  const cardsPerRowMobile = 3; // Nombre de cartes par ligne en mode mobile
  ...
  const isMobile = window.innerWidth <= 767; // Détecter si l'écran est de petite taille (mobile)

  const cardsPerPage = isMobile ? cardsPerPageMobile : cardsPerPageDesktop;
  const cardsPerRow = isMobile ? cardsPerRowMobile : cardsPerRowDesktop;
