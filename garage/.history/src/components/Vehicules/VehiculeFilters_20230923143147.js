...
const VehiculeFilters = ({ onSearch }) => {
  ...
  const handleChange = (name, newValue) => {
    //Impossible de communiquer directement entre parents et fils, on utilisera donc la fonction handlechange il sera passer en props pour chaque composant fils
