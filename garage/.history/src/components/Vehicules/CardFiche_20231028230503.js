  ...
  return (
    ...
    <div className="card text-center border-4 border-primary ">
      <div className="card-body  ">
        ...
        <p className="card-text lead"><strong>Année: {props.annee}</p>
        <p className="card-text lead"><strong>Date De Circulation: {formatDateCirculation(props.datecirculation)}</p>
        <p className="card-text lead"><strong>Famille: {props.famille}</p>
        <p className="card-text lead"><strong>Énergie: {props.energie}</p>
        <p className="card-text lead"><strong>Kilomètrage: {props.kilometrage} Km</p>
        <p className="card-text lead"><strong>Boite De Vitesse: {props.boitevitesse}</p>
        <p className="card-text lead"><strong>Puissance: {props.puissance}</p>
        <p className="card-text lead"><strong>Places: {props.places}</p>
        <p className="card-text lead"><strong>Couleur: {props.couleur}</p>
        <p className="card-text lead"><strong>Description <br /> {props.description}</p>
