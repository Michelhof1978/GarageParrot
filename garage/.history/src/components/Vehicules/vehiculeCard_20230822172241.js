...
N'oubliez pas d'adapter les noms des champs (`imagevoiture`, `marque`, `modele`, `energie`, `prix`, etc.) en fonction de la structure des données de votre table. Utilisez la syntaxe `vehicule.champ` pour accéder aux valeurs spécifiques de chaque véhicule dans la boucle `map`.