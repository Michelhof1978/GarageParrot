  ...
  const handleSearch = async () => {
    try {
      ...
      const response = await axios.get(
        `http://localhost/garageback/front/voiturefiche/all/?&anneeMin=${filtres.anneeMin}&anneeMax=${filtres.anneeMax}&famille=${filtres.famille.join(",")}&prixMin=${filtres.prixMin}&prixMax=${filtres.prixMax}&kilometrageMin=${filtres.kilometrageMin}&kilometrageMax=${filtres.kilometrageMax}`
      );
