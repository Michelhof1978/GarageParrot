...
const VehiculeFiche = () => {
  Vérifiez les Paramètres d'URL : Assurez-vous que vous accédez correctement aux paramètres d'URL dans le composant VehiculeDetails. Vous devriez utiliser useParams si vous utilisez des hooks, ou props.match.params si vous utilisez une classe.
