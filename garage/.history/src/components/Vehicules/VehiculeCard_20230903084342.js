...
import Pagination from "./Pagination"; // Décommentez cette ligne pour importer le composant Pagination
...
const VehiculeCard = () => {
  ...
  return (
    <div className="vehicule-grid">
      ...
      {/* Décommentez la section ci-dessous pour utiliser le composant Pagination */}
      <Pagination
