      ...
      <div id="carouselExampleCaptions" className="carousel slide carousel-fade carouselIndex" data-bs-ride="carousel">
        ...
        <div className="carousel-inner">
          ...
          <div className="carousel-item">
            <img src={carousselEntretient03} className="d-block w-100" alt="Slide 2" />
            <div className="carousel-caption d-none d-md-block">
          ...
          <div className="carousel-item">
            <img src={carousselEntretient04} className="d-block w-100" alt="Slide 3" />
            <div className="carousel-caption d-none d-md-block">
          ...
          <div className="carousel-item">
            <img src={carousselEntretient05} className="d-block w-100" alt="Slide 3" />
            <div className="carousel-caption d-none d-md-block">
              <h5>Titre de la diapositive 3</h5>
              <p>Description de la diapositive 3</p>
            </div>
          ...
          <div className="carousel-item">
            <img src={carousselEntretient06} className="d-block w-100" alt="Slide 3" />
            <div className="carousel-caption d-none d-md-block">
              <h5>Titre de la diapositive 3</h5>
              <p>Description de la diapositive 3</p>
            </div>
          ...
          <div className="carousel-item">
            <img src={carousselEntretient07} className="d-block w-100" alt="Slide 3" />
            <div className="carousel-caption d-none d-md-block">
              <h5>Titre de la diapositive 3</h5>
              <p>Description de la diapositive 3</p>
            </div>
          ...
          <div className="carousel-item">
            <img src={carousselEntretient08} className="d-block w-100" alt="Slide 3" />
            <div className="carousel-caption d-none d-md-block">
              <h5>Titre de la diapositive 3</h5>
              <p>Description de la diapositive 3</p>
            </div>
