...
const Navbar = (props) => (
  <>
  <div class="container-fluid"> <!-- Utiliser "container-fluid" pour une largeur maximale -->
    <div class="row">
      <div class="col-12 p-0"> <!-- Utiliser "col-12" pour occuper toute la largeur, "p-0" pour supprimer les marges -->
        <img src="chemin_vers_votre_image.jpg" class="img-fluid" alt="Image en pleine largeur">
      </div>
    </div>
  </div>
