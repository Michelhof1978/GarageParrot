...
const Navbar = (props) => (
  <>
    ...
    {/*------------NAVBAR----------- */}
    <nav className="navbar navbar-expand-lg bg-primary p-0 text-light " data-bs-theme="dark">
        ...
        <div className="collapse navbar-collapse" id="navbarColor01">
          <ul className="navbar-nav mx-auto navbar-text-light lead">
            ...
            <li className="nav-item dropdown m-3">
              <a className="nav-link dropdown-toggle text-white" data-bs-toggle="dropdown" href="/reparation" role="button" aria-haspopup="true" aria-expanded="false">
                Réparation véhicules
              </a>
              <div className="dropdown-menu bg-light">
                <NavLink className="dropdown-item text-primary" to="/pneumatique">
                  Pneumatique
                </NavLink>
                <NavLink className="dropdown-item text-primary" to="/freinage">
                  Freinage
                </NavLink>
                <NavLink className="dropdown-item text-primary" to="/mecanique">
                  Mécanique
                </NavLink>
                <NavLink className="dropdown-item text-primary" to="/entretien">
                  Entretien
                </NavLink>
                <NavLink className="dropdown-item text-primary" to="/parebrise">
                  Pare-Brise
                </NavLink>
                <NavLink className="dropdown-item text-primary" to="/vidange">
                  Vidange
                </NavLink>
              </div>
            </li>
            ...
            <li className="nav-item m-3">
              <NavLink to="/voitureoccasion" className="nav-link text-white">
                Voitures D'occasions
              </NavLink>
            </li>

            <li className="nav-item m-3">
              <NavLink to="/avisClients" className="nav-link text-white">
                Avis Clients
              </NavLink>
            </li>
    ...
    <div className="container-fluid">
      <div className="row">
        <div className="col-12 text-center p-0">
          <img className="img-fluid w-100 " src={banner} alt="banniere arrivage voitures" />
        </div>
      </div>
    </div>
    {/*------------END BANNER----------- */}
