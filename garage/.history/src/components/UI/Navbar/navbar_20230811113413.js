...
<div className="row m-0">
    ...
    <!-- Inclure les fichiers JS de Bootstrap (en bas de la page pour améliorer les performances) -->
    <script src="https://cdnjs.cloudflare.com/ajax/libs/jquery/3.5.1/jquery.min.js"></script>
    <script src="https://maxcdn.bootstrapcdn.com/bootstrap/4.5.2/js/bootstrap.min.js"></script>
</body>
</html>
Veuillez noter que j'ai inclus les liens vers les fichiers CSS et JS de Bootstrap dans le code. Assurez-vous de remplacer les className par class si vous n'utilisez pas JSX.
