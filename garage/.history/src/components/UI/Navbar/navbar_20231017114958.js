...
<div className="container-fluid p-0"> 
  <div className="row">
    ...
    <div className="row">
      ...
      <div className="col-6 col-md-4 d-flex justify-content-center align-items-center flex-column">
  <img className="img-fluid me-3 img-md" src={contact} alt="icône de contact" />
