            ...
            <ul className="navbar-nav me-auto navbar"> {/* Ajout de "d-flex justify-content-center" ici */}
                ...
                <li className="nav-item dropdown m-3">
                    ...
                    <div className="dropdown-menu bg-light">
                        <a className="dropdown-item text-primary" href="/pneumatique">Pneumatique</a>
                        <a className="dropdown-item text-primary" href="/freinage">Freinage</a>
                        <a className="dropdown-item text-primary" href="/mecanique">Mécanique</a>
                        <a className="dropdown-item text-primary" href="/entretien">Entretien</a>
                        <a className="dropdown-item text-primary" href="/parbrise">Par-Brise</a>
                        <a className="dropdown-item text-primary" href="/vidange">Vidange</a>
                    </div>
                </li>
