...
<div className="container-fluid p-0"> 
  ...
  <img className="img-fluid me-3 img-lg" src={contact} alt="icône de contact" />
  <p className="fw-bold text-dark text-center fs-4">
    Nous contacter
  </p>
  <p className="fw-bold text-primary text-center fs-4 d-md-none">04-70-45-25-36</p>
</div>
