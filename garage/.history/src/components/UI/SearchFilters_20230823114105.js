        ...
        <div className="filter-row">
          ...
          <div className="range-filter">
            ...
            <input
              ...
              step="1000"
            />
            <span>{currentMousePosition.prixMax.toFixed(0)} €</span>
          </div>
        </div>
        ...
        <div className="filter-row">
          ...
          <div className="range-filter">
            ...
            <input
              ...
              step="1"
            />
            <span>{currentMousePosition.anneeMax.toFixed(0)}</span>
          </div>
        </div>
        ...
        <div className="filter-row">
          ...
          <div className="range-filter">
            ...
            <input
              ...
              step="1000"
            />
            <span>{currentMousePosition.kilometrageMax.toFixed(0)}</span>
          </div>
        </div>
