...
import CarCard from "../../components/voitureOccasion/voitureOccasionFiche";
      ...
      <>
        ...
        <div className="container-fluid">
          <div className="row no-gutters">
            {this.state.cars &&
              this.state.cars.map((vehicule) => { // Utiliser vehicule comme paramètre
                return (
                  <div className="col-12 col-md-6 col-xl-4" key={vehicule.id}>
                    <CarCard {...vehicule} /> {/* Utiliser CarCard au lieu de Cardcar */}
                  </div>
                );
              })}
          </div>
