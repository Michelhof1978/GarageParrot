...
lass VehiculeCard extends Component {
  state = {
    voitureDetails: null,
  };
  ...
  render() {
    ...
    const { marque, modele, energie, prix, image } = voitureDetails; // Ajout de 'image'

    return (
      <div className="card">
        <img src={image} className="card-img-top" alt={marque} /> {/* Ajout de l'image */}
