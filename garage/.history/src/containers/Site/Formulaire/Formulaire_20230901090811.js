...
<div className="col">
    <div className="form-outline">
        <input name="phoneNumber" onChange={props.handleChange} value={props.values.nom} type="tel" id="phoneNumber" className="form-control" placeholder="Téléphone" required/>
