...
<div className="row mb-4">
    ...
    <div className="col">
        <div className="form-outline">
            <input name="firstName" onChange={props.handleChange} value={props.values.firstname} type="text" id="firstName" className="form-control"placeholder="Prénom" required/>
...
<div className="col">
    <div className="form-outline">
        <input name="phoneNumber" onChange={props.handleChange} value={props.values.phone} type="tel" id="phoneNumber" className="form-control" placeholder="Téléphone" required/>
