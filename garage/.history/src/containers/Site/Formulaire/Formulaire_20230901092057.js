...
<div className="row mb-4">
    ...
    <div className="col">
        <div className="form-outline">
            <input name="firstName" onChange={props.handleChange} value={props.values.firstname} onBlu type="text" id="firstName" className="form-control"placeholder="Prénom" required/>
