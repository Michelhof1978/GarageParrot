...
export default Site;
Veuillez noter les changements dans l'import des composants et l'ajout de la balise <Router>. Assurez-vous d'importer correctement Router, Route et Routes depuis react-router-dom.
