...
import VehiculesDetails from '../../containers/Site/VehiculeFiche';
  ...
  render() {
    return (
        ...
        <Route path="/" element={<Accueil />} />
            ...
            <Route path="/vehiculedetails/:id" element={<VehiculeFiche />} />
            <Route path="/contact" element={<Contact/>} />
            <Route path="/reparation" element={<Reparation/>} />
            <Route path="/avisclients/:id" element={<AvisClients/>} />
