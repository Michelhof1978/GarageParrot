...
const VehiculesFilters = ({ onSearch }) => {
  ...
  return (
   ...
   <Textes>
   Qualité des Voitures : Chacune de nos voitures d'occasion subit une inspection rigoureuse pour garantir qu'elle réponde aux normes de qualité les plus élevées. Nous sommes fiers de vous proposer une sélection de véhicules en excellent état, prêts à vous offrir des années de conduite sans souci.

Tarifs Compétitifs : Nous comprenons l'importance de maintenir votre véhicule en parfait état sans vous ruiner. C'est pourquoi nous offrons des tarifs compétitifs et transparents. Chez nous, vous obtenez un excellent rapport qualité-prix.

Garantie d'un An : Votre tranquillité d'esprit est notre priorité. C'est pourquoi nous offrons une garantie d'un an sur tous nos véhicules d'occasion. Nous croyons en la qualité de nos voitures, et nous sommes prêts à le prouver. En cas de problème, nous sommes là pour vous.     
       </Textes>
