        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-md-8">
              ...
              <Textes>
              Chez Garage Parrot à Toulouse, l'excellence est notre norme. Notre équipe de professionnels qualifiés s'engage à offrir des services automobiles de la plus haute qualité. Notre passion pour l'automobile, notre expertise technique et notre souci du détail font de nous le partenaire de confiance pour prendre soin de votre véhicule.
            </Textes>
