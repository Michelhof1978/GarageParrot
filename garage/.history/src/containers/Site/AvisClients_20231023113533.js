...
class AvisClients extends Component {
  ...
  handleSubmit = () => {
    ...
    console.log("Note:", thisstate.note);
            ...
            <div className="col-md-8">
              ...
              <form>
                <div className="form-group mb-3 fw-bold">
                  ...
                  <input
                    type="text"
                    className="form-control form-control-thick mb-3 fw-bold" // Classe ajoutée
                ...
                <div className="form-group mb-3 fw-bold">
                  ...
                  <input
                    type="text"
                    className="form-control form-control-thick mb-3" // Classe ajoutée
                ...
                <div className="form-group mb-3 fw-bold">
                  ...
                  <textarea
                    className="form-control form-control-thick" // Classe ajoutée
