Votre JSX est correct, cependant, il semble y avoir un mélange de code au niveau de `componentDidMount` qui apparaît deux fois dans votre composant. Je vais simplifier le code pour vous :
...
J'ai réorganisé le code pour que `componentDidMount` ne soit déclaré qu'une seule fois et pour que tout soit correctement encapsulé dans le rendu JSX. Veuillez utiliser cette version corrigée dans votre application.