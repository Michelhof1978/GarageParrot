...
class AvisClients extends Component {
  ...
  handleSubmit = () => {
    ...
    // Va Créer un objet contenant les données de l'avis
    const avisData = {
      nom,
      prenom,
      note,
    ...
    .then((response) => {
      ...
      // Mettez à jour l'état pour afficher le message de confirmation
      this.setState({
        avisEnvoye: true,
        nom: "", // Réinitialisez les champs du formulaire si nécessaire
        prenom: "",
        note: 0,
        commentaire: "",
      });
