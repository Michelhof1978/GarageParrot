...
const handleChange = (name, newValue) => {//Lorsque la valeur du slidr change la fonction handleChange sera appellé" et qui mettra à jour l'état local avec la nouvelle valeur
 console.log(value)
setValue(newValue);
 //la fonction sera appelé par handleChange si une valeur change et Va transmettre cette valeur au compmosant parent
