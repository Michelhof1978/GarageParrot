  ...
  return (
    ...
    <div className="search-filters">
      ...
      <div className="checkbox-filter">
        <BasicCheckbox handleCheckBoxChange= label="Utilitaire" name="famille" value="utilitaire" />
        <BasicCheckbox handleCheckBoxChange= label="berline" name="famille" value="berline" />
        <BasicCheckbox handleCheckBoxChange= label="familiale" name="famille" value="familiale" />
        <BasicCheckbox handleCheckBoxChange= label="citadine" name="famille" value="citadine" />
        <BasicCheckbox handleCheckBoxChange= label="SUV" name="famille" value="SUV" />
      </div>
