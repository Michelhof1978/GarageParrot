  ...
  return (
    ...
    <div className="search-filters">
      ...
      <div className="checkbox-filter">
        <BasicCheckbox hand label="Utilitaire" name="famille" value="utilitaire" />
        <BasicCheckbox hand label="berline" name="famille" value="berline" />
        <BasicCheckbox hand label="familiale" name="famille" value="familiale" />
        <BasicCheckbox hand label="citadine" name="famille" value="citadine" />
        <BasicCheckbox hand label="SUV" name="famille" value="SUV" />
      </div>
