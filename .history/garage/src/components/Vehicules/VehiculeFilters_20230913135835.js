  ...
  return (
    ...
    <div className="search-filters">
      ...
      <div className="checkbox-filter">
        <BasicCheckbox handdle label="Utilitaire" name="famille" value="utilitaire" />
        <BasicCheckbox handdle label="Utilitaire" name="famille" value="utilitaire" />
        <BasicCheckbox handdle label="Utilitaire" name="famille" value="utilitaire" />
        <BasicCheckbox handdle label="berline" name="famille" value="berline" />
        <BasicCheckbox handdle label="familiale" name="famille" value="familiale" />
        <BasicCheckbox handdle label="citadine" name="famille" value="citadine" />
        <BasicCheckbox handdle label="SUV" name="famille" value="SUV" />
      </div>
