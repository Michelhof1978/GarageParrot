  ...
  return (
    ...
    <div className="search-filters">
      ...
      <div className="checkbox-filter">
        ...
        <BasicCheckbox han label="berline" name="famille" value="berline" />
        <BasicCheckbox han label="familiale" name="famille" value="familiale" />
        <BasicCheckbox han label="citadine" name="famille" value="citadine" />
