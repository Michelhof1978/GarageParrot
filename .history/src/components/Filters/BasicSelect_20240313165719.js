...
{/*Rend un élément de menu déroulant (select) qui appelle la fonction handleChange lorsqu'une option est modifiée. Le nom du menu déroulant est spécifié par la prop name */}
