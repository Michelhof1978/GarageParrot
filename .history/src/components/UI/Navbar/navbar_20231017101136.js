...
<div className="container-fluid p-0"> 
  ...
  <img className="img-fluid me-3" src={contact} alt="contact icon" />
  <div>
    <p className="fw-bold text-primary text-center fs-4">Nous contacter au <p className="text-primary text-center">04-70-45-25-36</p></p>
  </div>
</div>
