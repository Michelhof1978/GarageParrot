...
const CardFiche = (props) => {
  ...
  return (
    <>
      <Textes>
        Les réparateurs du Garage Parrot s’occupent de la réparation et
        ...
        nous contactant via le formulaire pour la réparation de votre voiture et
        obtenez un RDV immédiat !
      </Textes>
      ...
      <div className="card text-center border-4 border-primary ">
        <div className="card-body  ">
          ...
          <h5 className="card-title text-primary lead fw-bold mb-4">
          ...
          <p className="card-text lead">
            ...
            {formatDateCirculation(props.datecirculation)}
          </p>
          <p className="card-text lead">
            <strong>Famille:</strong> {props.famille}
          </p>
          <p className="card-text lead">
            <strong>Énergie:</strong> {props.energie}
          </p>
          <p className="card-text lead">
            <strong>Kilomètrage:</strong> {props.kilometrage} Km
          </p>
          <p className="card-text lead">
            <strong>Boite De Vitesse:</strong> {props.boitevitesse}
          </p>
          <p className="card-text lead">
            <strong>Puissance:</strong> {props.puissance}
          </p>
          <p className="card-text lead">
            <strong>Places:</strong> {props.places}
          </p>
          <p className="card-text lead">
            <strong>Couleur:</strong> {props.couleur}
          </p>
          ...
          <a
            href={props.imageCritere}
            target="_blank"
            rel="noopener noreferrer"
          >
            <img
              src={imageCritere}
              alt={props.imageCritere}
              style={imageCritereCss}
            />
          </a>
          <Textes>
            <p className="card-text fw-bold text-primary lead">
              Prix: {props.prix} €
            </p>
          </Textes>
        </div>
