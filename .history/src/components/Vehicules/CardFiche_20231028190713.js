...
const CardFiche = (props) => {
  ...
  return (
    <div className="card text-center border-4 border-primary"> {/* Utilisez la classe "border-primary" pour le contour en couleur primaire */}
      <div className="card-body">
        ...
        <p className="card-text">Date De circulation: {props.datecirculation} </p>
