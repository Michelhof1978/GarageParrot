...
console.log(currentCards);
  return (
    ...
    <div>
      ...
      <PaginationComponent
          currentPage={currentPage}//Page actuellement active. Obtention de cette valeur à partir de l'état local avec const [currentPage, setCurrentPage] = useState(1);
          totalPages={Math.ceil(vehicules.length / cardsPerPage)}//Nb total des pages, calculé en fonction de la longueur du tableau et du nombre de carte
