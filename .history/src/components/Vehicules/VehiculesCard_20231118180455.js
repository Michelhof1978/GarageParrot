...
de la bibliothèque React-Bootstrap pour créer une série de boutons de pagination.
 ...
 fonction du nombre total de pages nécessaires pour afficher tous les véhicules, 
 et elle met en surbrillance la page active. Lorsqu'un bouton est cliqué, la fonction `paginate` est appelée pour mettre à jour la page actuelle.