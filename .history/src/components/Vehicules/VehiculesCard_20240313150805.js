...
//La syntaxe return () => {}; définit une fonction de nettoyage qui sera exécutée lors du démontage du composant ou lorsqu'une nouvelle exécution de l'effet est déclenchée. Dans ce cas, une fonction vide est renvoyée, ce qui signifie qu'il n'y a pas de nettoyage nécessaire.
