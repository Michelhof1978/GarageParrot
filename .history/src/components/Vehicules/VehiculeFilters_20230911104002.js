...
const VehiculeFilters = ({ onSearch }) => {
  ...
  return (
    <div className="search-filters">
      ...
      label = "Année :"
      name = "annee"
      marks = {[{value:2000, label:"2000 "}, {value:2023, label:"2023 " }]} //En variable pour les props, mettre une accolable
      range = {[2000,2023]}
      /> 
      ...
      label = "Kilométrage :"
      name = "kiolmetrage"
      marks = {[{value:0, label:"0 "}, {value:200000, label:"200 000 km" }]} //En variable pour les props, mettre une accolable
      range = {[0,200000]}
      /> 
