...
//Création d'une copie de la liste des véhicules extraits pour éviter de modifier l'original directement
        const sortedVehicules = [...jsonData];

// tri des véhicules en fonction de leur date de création
