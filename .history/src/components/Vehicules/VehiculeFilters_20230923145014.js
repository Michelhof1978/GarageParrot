...
const VehiculeFilters = ({ onSearch }) => {
  ...
  useEffect(() => {
    fetch(//fetch effectue une requête http et retourne une promesse
    ...
    //Si reponse reçu de la requête http:
      .then((res) => res.json())// Va extraire les données en format json
      .then((data) => console.log(data))
      .catch((err) => console.log(err));//Si erreur de la requête,
  }, []);
