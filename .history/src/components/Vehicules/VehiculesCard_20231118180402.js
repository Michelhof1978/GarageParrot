...
Cette partie du code utilise la pagination fournie par le composant `Pagination` de la bibliothèque React-Bootstrap pour créer une série de boutons de pagination. Voici une explication détaillée :