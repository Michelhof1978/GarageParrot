...
extraites de l'objet vehicule, qui représente les données d'un véhicule spécifique à
 afficher dans la carte. Le composant Card utilise ensuite ces propriétés pour afficher les détails du véhicule dans son rendu.