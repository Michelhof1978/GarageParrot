...
const VehiculesCard = () => {
  ...
  const [vehicules, setVehicules] = useState([]);// tableau vehicules est initialisé à vide ([]) afin de représenter un état initial où aucune donnée de véhicule n'a encore été récupérée et sera ajouté grâce à setVehicule
