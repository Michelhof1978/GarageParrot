...
const VehiculesCard = () => {
  //Le hook useState est utilisé pour ajouter l'état à un composant fonctionnel React. Il prend un argument initial et renvoie un tableau contenant deux éléments : la valeur actuelle de l'état et une fonction pour mettre à jour cet état.
