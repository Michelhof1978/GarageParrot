...
const VehiculesCard = () => {
  ...
  useEffect(() => {
    //Utilisation de la bibliothèque Axios pour effectuer une requête HTTP GET vers l'URL spécifiée, qui semble être l'endpoint d'une API fournissant des informations sur les véhicules.
    axios
