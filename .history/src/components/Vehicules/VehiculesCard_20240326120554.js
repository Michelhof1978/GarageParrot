...
//Tri des données grâce à la méthode sort() en fonction de la date de création en mode décroissant d'un véhicule. Les données sont triées en ordre croissant en utilisant la date de création comme critère
        jsonData.sort(
