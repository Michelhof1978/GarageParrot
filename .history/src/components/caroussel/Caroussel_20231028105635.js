...
import EnSavoirPlusButton from '../UI/Button/EnSavoirPlusButton';
        ...
        <div className="carousel-inner">
          <div className="carousel-item active">
            ...
            <div className="carousel-caption">
              ...
              <EnSavoirPlusButton to="/reparation">En savoir plus </EnSavoirPlusButton>
            </div>
          </div>
          ...
          <div className="carousel-item">
            ...
            <div className="carousel-caption">
              ...
              <Link to="/reparation" className="btn btn-primary btn-md  lead">Plus d'Infos Ici !</Link>
            </div>
          </div>
        </div>
