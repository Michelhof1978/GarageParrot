...
const AvisClients = () => {
  const avis = [
    ...
    ["Ce garage a dépassé mes attentes. Leur équipe a réparé ma voiture rapidement, et le travail était de grande qualité. En plus de cela, le service client était exceptionnel. Je suis extrêmement satisfait et je les recommande à tous mes amis et ma famille. " , "Germaine"],
      ...
      <div className="row align-items-center justify-content-center h-100">
        <div className="col-md-8 col-lg-6 p-3">
          ...
          <div className="mt-2 text-center p-3 text-white font-weight-bold text-uppercase" id="nouveau" onClick={handleNouveauAvis}>
           Nos Avis Clients Actualisés Toutes Les Semaines
          </div>
        </div>
      </div>
    </section> <TitreH2>Découvrez nos prestations</TitreH2>
  );
};
