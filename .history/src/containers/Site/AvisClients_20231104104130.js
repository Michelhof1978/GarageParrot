        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-md-8">
              ...
              <form>
              <div className="form-group mb-3 lead"> {/* Supprimer form-control-thick */}
  <label className="mb-2">Nom :</label>
  <input
    type="text"
    className="form-control mb-3 lead" {/* Supprimer form-control-thick */}
    style={stylesInput}
...
<div className="form-group mb-3 lead"> {/* Supprimer form-control-thick */}
  ...
  <input
    type="text"
    className="form-control" {/* Supprimer form-control-thick */}
    style={stylesInput}
