...
const VehiculeFiche = () => {
  ...
  // Supposons que vous ayez les données de tous les véhicules dans "vehicules".
  const vehicules = []; // Remplacez ceci par votre liste de véhicules
  const cardsPerPage = 10; // Définissez le nombre de cartes par page ici.
