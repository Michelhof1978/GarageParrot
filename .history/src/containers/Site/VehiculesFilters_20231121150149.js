...
mise à jour en utilisant la méthode join(","). Cette méthode crée une chaîne de caractères en joignant tous les éléments du tableau avec une virgule comme séparateur.
