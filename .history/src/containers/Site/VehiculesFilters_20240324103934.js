...
//fonction handleClick pour construire l'URL de requête en fonction des filtres sélectionnés et mettre à jour l'état lien
  const handleClick = () => {
    ...
    //Si la condition est vraie, cela signifie que le tableau filtres.famillecontient des éléments. Dans ce cas, la propriété famille de l'objet lienObject est
