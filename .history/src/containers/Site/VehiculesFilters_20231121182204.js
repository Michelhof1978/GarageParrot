...
//CHECKBOX
//fonction utilisée pour gérer le changement d'état d'une case à cocher (checkbox) dans une interface utilisateur. Elle prend en paramètre un événement (e) généré par le changement d'état de la case à cocher.
