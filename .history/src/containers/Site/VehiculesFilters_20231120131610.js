...
{/* FIN BOUTON FILTRE------------------------------------------------------------ */}
      ...
      <div className="row">
Fonction map qui va itérer sur chaque élément du tableau 'card' et execute une fonction pour chaque élément. La fonction prend en paramétre chaque élément
        {cards.map((vehicule) => (
          <div
