...
// key =  aide à identifier de manière unique chaque élément généré dynamiquement au sein d'une liste
      ...
      <PaginationComponent
          currentPage={pageNumber + 1} //Pour afficher le numéro de page en indiquant bien que l'on veut commencer à 1 et non à 0
         
//Définit la propriété totalPages du composant 4PaginationComponent avec la valeur pagesCount. Cette propriété représente le nombre total de pages disponibles dans la pagination.
