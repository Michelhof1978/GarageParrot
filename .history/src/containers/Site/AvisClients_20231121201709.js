...
const AvisClients = () => {
  useEffect(() => {
    // Titre de la page
    document.title = "Presentation des sérvices"; //// Le tableau vide signifie que cet effet ne dépend d'aucune variable et ne sera exécuté qu'une fois après le montage du composant
  }, []);
  ...
  const enregistrerAvis = (e) => {
    ...
    axios
      ...
      .catch((error) => {
        console.error(
          "Une erreur s'est produite lors de l'enregistrement de l'avis :",
          error
        );
      });
  };
      ...
      <div className="container">
        <div className="row justify-content-center">
          <div className="col-md-8">
            ...
            <Textes>
              Chez Garage Parrot à Toulouse, l'excellence est notre norme. Notre
              équipe de professionnels qualifiés s'engage à offrir des services
              automobiles de la plus haute qualité. Notre passion pour
