      ...
      <div className="container">
        ...
        <div className="search-filters">
          ...
          //Elle est destinée à être utilisée comme une fonction de rappel
           (handleCheckBoxChange) qui sera exécutée lorsque l'état de la case à cocher change. Cette fonction gère généralement la mise à jour de l'état dans le composant parent.
