...
//Si la condition dans le if est vraie, cela signifie que le tableau filtres.famille contient des éléments. Dans ce cas, la propriété famille de l'objet lienObject est mise à jour en utilisant la méthode join(","). Cette méthode crée une chaîne de caractères en joignant tous les éléments du tableau avec une virgule comme séparateur.
