...
const Prestation = (props) => {
  useEffect(() => {
    // Titre de la page
    document.title = "Presentation des srvices"; //Le tableau vide signifie que cet effet ne dépend d'aucune variable et ne sera exécuté qu'une fois après le montage du composant
  }, []);
