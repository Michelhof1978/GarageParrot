...
//onction handlePageClick est définie pour mettre à jour le numéro de page (pageNumber) en fonction de la page sélectionnée.
// Cette fonction est généralement utilisée en réponse à une interaction de l'utilisateur, par exemple, en cliquant sur un bouton de pagination.
