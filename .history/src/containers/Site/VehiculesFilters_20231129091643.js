...
//déclenche une requête HTTP vers l'URL spécifiée par lien chaque fois que la valeur de lien change. Une fois les données reçues, elles sont transformées en JSON, mises à jour dans l'état de l'application avec setCards(data)
